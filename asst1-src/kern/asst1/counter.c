...
struct lock *lock; // use the lock to enforce mutual exclusion
/*
 * ********************************************************************
...
{
        lock_acquire(lock); // The same format as lecture slides
...
int counter_initialise(int val)
{
         ...
         * ********************************************************************
         */
        lock = lock_create("count"); // create lock
...
int counter_read_and_destroy(void)
{
         ...
         * **********************************************************************
         */
        lock_destroy(lock); // destroy lock
